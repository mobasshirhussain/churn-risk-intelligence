...
st.markdown(
    "<div style='text-align:center;color:#cbd5e1;'>AI-powered churn prediction with strategic retention insights</div>",
    unsafe_allow_html=True
)
...
with center:
    analyze = st.button("🚀 Analyze Customer Risk", use_container_width=True)
